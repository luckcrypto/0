// Luck.fyi lottery drum — china-super-lotto
...
function startLotteryDrum(canvasId) {
    ...
    const POOLS = [{fill:'#D4194F',text:'#ffffff',nums:R(1,35)},{fill:'#2F73D8',text:'#ffffff',nums:R(1,12)}];
...
startLotteryDrum("CHINA-SUPER-LOTTO");
