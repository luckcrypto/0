// Luck.fyi lottery drum — german-lotto-6aus49
...
function startLotteryDrum(canvasId) {
    ...
    const POOLS = [{fill:'#ffffff',text:'#000000',nums:R(1,49)},{fill:'#D4194F',text:'#ffffff',nums:R(0,9)}];
...
startLotteryDrum("GERMAN-LOTTO-6AUS49");
