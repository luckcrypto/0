// Luck.fyi lottery drum — double-color-ball
...
function startLotteryDrum(canvasId) {
    ...
    const POOLS = [{fill:'#D4194F',text:'#ffffff',nums:R(1,33)},{fill:'#2F73D8',text:'#ffffff',nums:R(1,16)}];
...
startLotteryDrum("DOUBLE-COLOR-BALL");
